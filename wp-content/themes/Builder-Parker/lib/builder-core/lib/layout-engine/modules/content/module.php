...
if ( ! class_exists( 'LayoutModuleContent' ) ) {
	class LayoutModuleContent extends LayoutModule {
		...
		function __construct() {
			$this->_name = _x( 'Content', 'module', 'it-l10n-Builder-Parker' );
			$this->_description = __( 'This module adds a place for the content to render. Most layouts will have this module.', 'it-l10n-Builder-Parker' );
