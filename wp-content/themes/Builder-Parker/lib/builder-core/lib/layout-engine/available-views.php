...
function builder_set_available_views( $views ) {
	$new_views = array(
		'builder_is_home'     => array(
			'name'        => _x( 'Home', 'view', 'it-l10n-Builder-Parker' ),
			'priority'    => '20',
			'description' => __( 'The front page or home of your site', 'it-l10n-Builder-Parker' ),
		),
		'builder_is_singular' => array(
			'name'        => _x( 'Singular', 'view', 'it-l10n-Builder-Parker' ),
			'priority'    => '5',
			'description' => __( 'Any post, page, or attachment', 'it-l10n-Builder-Parker' ),
		),
		'is_single'           => array(
			'name'        => _x( 'Post', 'view', 'it-l10n-Builder-Parker' ),
			'priority'    => '10',
			'description' => __( 'Any post', 'it-l10n-Builder-Parker' ),
		),
		'builder_is_page'     => array(
			'name'        => _x( 'Page', 'view', 'it-l10n-Builder-Parker' ),
			'priority'    => '10',
			'description' => __( 'Any page', 'it-l10n-Builder-Parker' ),
		),
		'is_attachment'       => array(
			'name'        => _x( 'Attachment', 'view', 'it-l10n-Builder-Parker' ),
			'priority'    => '15',
			'description' => __( 'Any attachment (image or other attached file)', 'it-l10n-Builder-Parker' ),
		),
		'is_archive'          => array(
			'name'        => _x( 'Archives', 'view', 'it-l10n-Builder-Parker' ),
			'priority'    => '5',
			'description' => __( 'Any archive view (category, tag, author, or date)', 'it-l10n-Builder-Parker' ),
		),
		'is_category'         => array(
			'name'        => _x( 'Category', 'view', 'it-l10n-Builder-Parker' ),
			'priority'    => '10',
			'description' => __( 'Any category archive view', 'it-l10n-Builder-Parker' ),
		),
		'is_tag'              => array(
			'name'        => _x( 'Tag', 'view', 'it-l10n-Builder-Parker' ),
			'priority'    => '10',
			'description' => __( 'Any tag archive view', 'it-l10n-Builder-Parker' ),
		),
		'is_author'           => array(
			'name'        => _x( 'Author', 'view', 'it-l10n-Builder-Parker' ),
			'priority'    => '10',
			'description' => __( 'Any author archive view', 'it-l10n-Builder-Parker' ),
		),
		'is_date'             => array(
			'name'        => _x( 'Date Archive', 'view', 'it-l10n-Builder-Parker' ),
			'priority'    => '10',
			'description' => __( 'Any date-specific view (such as year, month, or day)', 'it-l10n-Builder-Parker' ),
		),
		'is_search'           => array(
			'name'        => _x( 'Search Results', 'view', 'it-l10n-Builder-Parker' ),
			'priority'    => '5',
			'description' => __( 'A search results page', 'it-l10n-Builder-Parker' ),
		),
		'is_404'              => array(
			'name'        => _x( '404', 'view', 'it-l10n-Builder-Parker' ),
			'priority'    => '5',
			'description' => __( 'The "Page Not Found" error page', 'it-l10n-Builder-Parker' ),
		),
	);
...
function builder_add_blog_view( $views ) {
	...
	$new_views = array(
		'builder_is_blog' => array(
			'name'          => _x( 'Blog', 'view', 'it-l10n-Builder-Parker' ),
			'priority'      => '20',
			'description'   => __( 'This view is for when a static page is used as the front (or home) page and you want to apply a specific layout to the selected posts page', 'it-l10n-Builder-Parker' ),
		),
	);
...
function builder_add_custom_post_types( $views ) {
	...
	foreach ( (array) $custom_post_types as $post_type => $name ) {
		$new_views["builder_is_custom_post_type|$post_type"] = array(
			'name'        => sprintf( _x( 'Post Type - %s', 'view', 'it-l10n-Builder-Parker' ), $name ),
			'priority'    => '15',
			'description' => sprintf( _x( 'Any %s entry', 'view description', 'it-l10n-Builder-Parker' ), $name ),
		);
	}
...
function builder_add_custom_taxonomies( $views ) {
	...
	foreach ( (array) $custom_taxonomies as $taxonomy => $name ) {
		$new_views["builder_is_custom_taxonomy|$taxonomy"] = array(
			'name'        => sprintf( _x( 'Taxonomy - %s', 'view', 'it-l10n-Builder-Parker' ), $name ),
			'priority'    => '15',
			'description' => sprintf( _x( 'Any %s taxonomy entry', 'view description', 'it-l10n-Builder-Parker' ), $name ),
		);
	}
...
function builder_add_multisite_views( $views ) {
	$new_views = array(
		'builder_is_signup_page' => array(
			'name'        => __( 'Signup Page', 'it-l10n-Builder-Parker' ),
			'priority'    => '20',
			'description' => __( 'The multisite user signup page (<code>wp-signup.php</code>)', 'it-l10n-Builder-Parker' ),
		),
	);
