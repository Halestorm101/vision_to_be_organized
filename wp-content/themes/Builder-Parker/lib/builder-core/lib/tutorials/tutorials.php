...
?>
<p><?php _e( 'Welcome to Builder. Throughout the theme\'s back-end, you can use this help pulldown to get additional information about the page you are looking at.', 'it-l10n-Builder-Parker' ); ?></p>
<p><?php _e( 'You may also see question mark icons next to some of the options or descriptions. If you hover over one of these icons, you will get additional information about that specific option.', 'it-l10n-Builder-Parker' ); ?></p>
<p><?php _e( 'The videos on this page help get you up and running quickly. At the bottom of the page are some important links such as access to iThemes support and member area.', 'it-l10n-Builder-Parker' ); ?></p>
<p><?php printf( __( 'After getting a feel for Builder from the videos, check out the <a href="%s">Layouts and Views</a> editor where you can start making modifications to your site to make it the site right for you.', 'it-l10n-Builder-Parker' ), admin_url( 'admin.php?page=layout-editor' ) ); ?></p>
<?php
	...
	function add_pages() {
		...
		$tutorial_menu_name = __( 'Start Here', 'it-l10n-Builder-Parker' );
		...
		if ( ! empty( $wp_theme_page_name ) ) {
			...
			$this->_page_ref = add_theme_page( sprintf( __( '%s Start Here', 'it-l10n-Builder-Parker' ), $wp_theme_name ), sprintf( __( '%s Start Here', 'it-l10n-Builder-Parker' ), $wp_theme_name ), $menu_capability, $this->_page, array( $this, 'index' ) );
		}
