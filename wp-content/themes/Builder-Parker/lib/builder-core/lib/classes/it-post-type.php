	...
	class ITPostType {
		...
		function __get_default_labels() {
			$labels = array(
				...
				'add_new'            => _x( 'Add New', 'post', 'it-l10n-Builder-Parker' ),
				'add_new_item'       => sprintf( _x( 'Add New %s', 'post', 'it-l10n-Builder-Parker' ), $this->_name ),
				'edit_item'          => sprintf( _x( 'Edit %s', 'post', 'it-l10n-Builder-Parker' ), $this->_name ),
				'new_item'           => sprintf( _x( 'New %s', 'post', 'it-l10n-Builder-Parker' ), $this->_name ),
				'view_item'          => sprintf( _x( 'View %s', 'post', 'it-l10n-Builder-Parker' ), $this->_name ),
				'search_items'       => sprintf( _x( 'Search %s', 'post', 'it-l10n-Builder-Parker' ), $this->_name_plural ),
				'not_found'          => sprintf( _x( 'No %s found', 'post', 'it-l10n-Builder-Parker' ), strtolower( $this->_name ) ),
				'not_found_in_trash' => sprintf( _x( 'No %s found in trash', 'post', 'it-l10n-Builder-Parker' ), strtolower( $this->_name_plural ) ),
				'parent_item_colon'  => sprintf( _x( 'Parent %s:', 'post', 'it-l10n-Builder-Parker' ), $this->_name ),
				'all_items'          => sprintf( _x( 'All %s', 'post', 'it-l10n-Builder-Parker' ), $this->_name_plural ),
			);
