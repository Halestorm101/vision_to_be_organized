...
if ( ! class_exists( 'ITDialog' ) ) {
	class ITDialog {
		...
		public static function add_enqueues() {
			...
			$vars = array(
				'no_iframes_message' => __( 'This feature requires inline frames. You have iframes disabled or your browser does not support them.', 'it-l10n-Builder-Parker' ),
				'loading_image'      => ITDialog::get_loading_image_url(),
				'close_message'      => __( 'Close', 'it-l10n-Builder-Parker' ),
