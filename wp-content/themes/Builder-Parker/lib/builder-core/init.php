...
$GLOBALS['it_builder_core_version'] = '5.1.1';
...
if ( ! isset( $GLOBALS['l10n']['it-l10n-Builder-Parker'] ) )
	load_theme_textdomain( 'it-l10n-Builder-Parker', get_stylesheet_directory() . '/lang' );
