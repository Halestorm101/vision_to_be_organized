				...
				<?php if ( have_posts() ) : ?>
						...
						<?php while ( have_posts() ) : the_post(); ?>
							<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
								...
								<div class="entry-footer">
									<?php printf( __( 'Posted on %s', 'it-l10n-Builder-Parker' ), '<span class="the_date">' . get_the_date() . '</span>' ); ?>
									<?php printf( __( 'by %s', 'it-l10n-Builder-Parker' ), '<span class="author">' . builder_get_author_link() . '</span>' ); ?>
									<?php do_action( 'builder_comments_popup_link', '<span class="comments">', '</span>', __( '%s Comments', 'it-l10n-Builder-Parker' ), __( '0', 'it-l10n-Builder-Parker' ), __( '1', 'it-l10n-Builder-Parker' ), __( '%', 'it-l10n-Builder-Parker' ) ); ?>
								</div>
							</div>
							<!-- end .post -->
						<?php endwhile; ?>
					...
					<div class="loop-footer">
						<div class="loop-utility clearfix">
							<div class="alignleft"><?php previous_posts_link( __( '&laquo; Previous Page', 'it-l10n-Builder-Parker' ) ); ?></div>
							<div class="alignright"><?php next_posts_link( __( 'Next Page &raquo;', 'it-l10n-Builder-Parker' ), $max_num_pages ); ?></div>
						</div>
					</div>	
				</div>
