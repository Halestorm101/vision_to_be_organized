						...
						<div <?php post_class( 'extension-column grid_wrapper' ) ?>>
							<div class="extension-column-inner inner">
								<p class="extension-slide-box slide_box">
									...
									<a href="<?php the_permalink(); ?>" class="permalink"><img src="<?php echo $directory_uri; ?>images/more.png" alt="Read This Article" /><?php printf( __( '<span>Read: %s</span>', 'it-l10n-Builder-Parker' ), '<strong>' . get_the_title() . '</strong>' ); ?></a>
								</p>
