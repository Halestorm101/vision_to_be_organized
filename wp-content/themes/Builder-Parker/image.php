					...
					<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
						...
						<div class="entry-header clearfix">
							<h1 class="entry-title">
								<?php if ( 0 != $post->post_parent ) : ?>
									<a href="<?php echo get_permalink( $post->post_parent ); ?>" rev="attachment"><?php echo get_the_title( $post->post_parent ); ?></a> &rarr; <?php the_title(); ?>
								<?php else : ?>
									<?php the_title(); ?>
								<?php endif; ?>
							</h1>
						...
						<div class="entry-content clearfix">
							...
							<div class="photometa clearfix">
								<div class="EXIF">
									<h4><?php _e( 'Image Data', 'it-l10n-Builder-Parker' ); ?></h4>
									...
									<?php if ( is_attachment() ) : ?>
										<?php
											...
											$meta_fields = array(
												'camera'            => __( 'Camera', 'it-l10n-Builder-Parker' ),
												'created_timestamp' => __( 'Date Taken', 'it-l10n-Builder-Parker' ),
												'aperture'          => __( 'Aperture', 'it-l10n-Builder-Parker' ),
												'focal_length'      => __( 'Focal Length', 'it-l10n-Builder-Parker' ),
												'iso'               => __( 'ISO', 'it-l10n-Builder-Parker' ),
												'shutter_speed'     => __( 'Shutter Speed', 'it-l10n-Builder-Parker' ),
												'credit'            => __( 'Credit', 'it-l10n-Builder-Parker' ),
												'copyright'         => __( 'Copyright', 'it-l10n-Builder-Parker' ),
												'title'             => __( 'Title', 'it-l10n-Builder-Parker' ),
											);
										?>
										
										<table>
											<tr>
												<th scope="row"><?php _e( 'Dimensions', 'it-l10n-Builder-Parker' ); ?></th>
